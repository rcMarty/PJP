...
public class TypeCheckVisitor extends ProjExprBaseVisitor<Types> {
    ...
    // OPERATOR
    @Override
    public Types visitLogicAnd(ProjExprParser.LogicAndContext ctx) {
    ...
    @Override
    public Types visitLogicOr(ProjExprParser.LogicOrContext ctx) {
    ...
    @Override
    public Types visitNegation(ProjExprParser.NegationContext ctx) {
    ...
    @Override
    public Types visitUnaryMinus(ProjExprParser.UnaryMinusContext ctx) {
    ...
    @Override
    public Types visitArithmetic(ProjExprParser.ArithmeticContext ctx) {
    ...
    @Override
    public Types visitModulo(ProjExprParser.ModuloContext ctx) {
    ...
    @Override
    public Types visitConcatenation(ProjExprParser.ConcatenationContext ctx) {
    ...
    @Override
    public Types visitComparison(ProjExprParser.ComparisonContext ctx) {
        log.trace("{}Visiting \toperation " + AnsiiColors.ANSI_YELLOW + ctx.op.getText() + AnsiiColors.ANSI_RESET, "    ".repeat(ctx.depth()));
        Types left = visit(ctx.expr(0));
        Types right = visit(ctx.expr(1));
    ...
    @Override
    public Types visitRelational(ProjExprParser.RelationalContext ctx) {
        log.trace("{}Visiting \toperation " + AnsiiColors.ANSI_YELLOW + ctx.op.getText() + AnsiiColors.ANSI_RESET, "    ".repeat(ctx.depth()));
        Types left = visit(ctx.expr(0));
        Types right = visit(ctx.expr(1));
...
//        return Types.INT;
    ...
    @Override
    public Types visitAssign(ProjExprParser.AssignContext ctx) {
    ...
    @Override
    public Types visitTernary(ProjExprParser.TernaryContext ctx) {
    ...
    // WILL BE USEFULL
    @Override
    public Types visitCondition(ProjExprParser.ConditionContext ctx) {
    ...
    @Override
    public Types visitDeclareStat(ProjExprParser.DeclareStatContext ctx) {
    ...
    @Override
    public Types visitId(ProjExprParser.IdContext ctx) {
    ...
    @Override
    public Types visitParens(ProjExprParser.ParensContext ctx) {
